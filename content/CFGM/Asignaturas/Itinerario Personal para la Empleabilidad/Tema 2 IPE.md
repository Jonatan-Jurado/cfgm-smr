...
![[Pasted-image-20260310224343.png]]
...
Legalmente (LGSS): lesión corporal sufrida en ocasión o consecuencia del trabajo por cuenta ajena.
...
Accidentes principales: caídas al mismo/diferente nivel, choques, cortes, proyección de partículas.
...
- *Contacto indirecto*: toca elemento con tensión accidental
Efectos: golpes, caídas, quemaduras, muerte por asfixia o paro cardiaco.
...
Contiene: identificación empresa, política preventiva, estructura jerárquica, organización de la prevención.

Proceso:
1. **Evaluación de riesgos**: análisis (identificar peligros, probabilidad, gravedad) + valoración (trivial/tolerable/moderado/importante/intolerable)
2. **Planificación preventiva**: según nivel de riesgo:
   - *Trivial* → sin acción
...
1. Situarse detrás de la víctima, brazos alrededor de la cintura
2. Puño por encima del ombligo, compresiones rápidas hacia arriba y adentro
3. Repetir hasta expulsar el objeto o pérdida de consciencia → iniciar RCP